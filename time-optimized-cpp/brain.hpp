...
public:
    ...
    int w;                                      //Number of winners, w是该区域上一轮的winner对这一轮输入的数量,也是这一轮中有连接记录的神经元数量
...
public:
    ...
    unordered_map<string, unordered_map<string, unordered_map<int, deque<float>>>> connectomes; 
    ...
    Brain(float p0 = 0, bool save_size0 = true, bool save_winners0 = false);
