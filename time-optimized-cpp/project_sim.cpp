...
void merge_sim(Brain &b, int n0 = 100000, int k0 = 317, float p0 = 0.01, float beta0 = 0.05, int max_t0 = 50)
{
...
int main(int argc, char *argv[])
{
    ...
    // project_sim(*b, 1000000, 1000, 0.01, 0.05, 50, false);
    merge_sim(*b,10000,100,0.01,0.05,50);
